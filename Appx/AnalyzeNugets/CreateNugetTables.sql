...
--ID
--Version
--Path (= \\fxcore\apps\nuget\bin\<id>_<version>.nupkg)
--downloadCount (from catalog)
---> supportedFrameworks "Name" (from catalog)
--Title
--Authors
--<references>.<reference> file=""
--dependencies.group targetFramework="", for each <dependency> id="" version=""
--<frameworkAssemblies>.<frameworkAssembly> assemblyName="" targetFramework=""

--then a load of directories, and files inside them. I will flatten the list of directories.

--lib\wpa81
--NuGet * Directory
--NuGet1,Directory1,SuffixString
