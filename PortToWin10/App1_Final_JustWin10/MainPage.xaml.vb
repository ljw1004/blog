...
Public NotInheritable Class MainPage
    ...
    Protected Overrides Async Sub OnNavigatedTo(e As NavigationEventArgs)
        ...
        While isOpen
            ...
            Dim new_img = If(App.useBeachBall, "ms-appx:///Assets/beach-ball.png",
                                               "ms-appx:///Assets/twelve-ball.png")
    ...
    Private Sub Page_SizeChanged(sender As Object, e As Windows.UI.Xaml.SizeChangedEventArgs) Handles Me.SizeChanged
