...
Namespace Global
    ...
    Class Stick
        ...
        Public ComputedPaintControllers As New List(Of Tuple(Of PaintController, CurrentPaintData))
        Public ComputedFractionControllers As New List(Of Tuple(Of FractionController, CurrentFractionData))
